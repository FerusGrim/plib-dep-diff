...
public class Metrics
{
    ...
    void logFailedRequests(final boolean value) {
        Metrics.logFailedRequests = value;
    }
    ...
    private void startSubmitting() {
        ...
        timer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                ...
                Bukkit.getScheduler().runTask(Metrics.this.plugin, (Runnable)new Runnable() {
                    @Override
                    public void run() {
    ...
    public JSONObject getPluginData() {
        ...
        final Pair<String, String> pluginVersion = Statistics.splitVersion();
        data.put((Object)"pluginName", (Object)pluginName);
        data.put((Object)"pluginVersion", pluginVersion.getLeft());
