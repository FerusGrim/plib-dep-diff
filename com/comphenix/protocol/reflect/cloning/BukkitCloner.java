...
public class BukkitCloner implements Cloner
{
    ...
    static {
        ...
        fromWrapper(MinecraftReflection::getIChatBaseComponentClass, (Function<Object, ClonableWrapper>)WrappedChatComponent::fromHandle);
        fromWrapper(WrappedVillagerData::getNmsClass, (Function<Object, ClonableWrapper>)WrappedVillagerData::fromHandle);
        try {
            fromManual(ComponentConverter::getBaseComponentArrayClass, source -> ComponentConverter.clone((BaseComponent[])source));
        }
        catch (Throwable t) {}
