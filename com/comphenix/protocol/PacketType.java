    ...
    public static class Play
    {
        ...
        public static class Server extends PacketTypeEnum
        {
            ...
            static {
                ...
                CHAT = new PacketType(Play.PROTOCOL, Server.SENDER, 14, 15, new String[] { "Chat" });
                MULTI_BLOCK_CHANGE = new PacketType(Play.PROTOCOL, Server.SENDER, 15, 16, new String[] { "MultiBlockChange" });
                TAB_COMPLETE = new PacketType(Play.PROTOCOL, Server.SENDER, 16, 14, new String[] { "TabComplete" });
                COMMANDS = new PacketType(Play.PROTOCOL, Server.SENDER, 17, -1, new String[] { "Commands" });
                TRANSACTION = new PacketType(Play.PROTOCOL, Server.SENDER, 18, 17, new String[] { "Transaction" });
                CLOSE_WINDOW = new PacketType(Play.PROTOCOL, Server.SENDER, 19, 18, new String[] { "CloseWindow" });
                OPEN_WINDOW = new PacketType(Play.PROTOCOL, Server.SENDER, 20, 19, new String[] { "OpenWindow" });
                WINDOW_ITEMS = new PacketType(Play.PROTOCOL, Server.SENDER, 21, 20, new String[] { "WindowItems" });
                WINDOW_DATA = new PacketType(Play.PROTOCOL, Server.SENDER, 22, 21, new String[] { "WindowData" });
                SET_SLOT = new PacketType(Play.PROTOCOL, Server.SENDER, 23, 22, new String[] { "SetSlot" });
                SET_COOLDOWN = new PacketType(Play.PROTOCOL, Server.SENDER, 24, 23, new String[] { "SetCooldown" });
                CUSTOM_PAYLOAD = new PacketType(Play.PROTOCOL, Server.SENDER, 25, 24, new String[] { "CustomPayload" });
                CUSTOM_SOUND_EFFECT = new PacketType(Play.PROTOCOL, Server.SENDER, 26, 25, new String[] { "CustomSoundEffect" });
                KICK_DISCONNECT = new PacketType(Play.PROTOCOL, Server.SENDER, 27, 26, new String[] { "KickDisconnect" });
                ENTITY_STATUS = new PacketType(Play.PROTOCOL, Server.SENDER, 28, 27, new String[] { "EntityStatus" });
                NBT_QUERY = new PacketType(Play.PROTOCOL, Server.SENDER, 29, -1, new String[] { "NBTQuery" });
                EXPLOSION = new PacketType(Play.PROTOCOL, Server.SENDER, 30, 28, new String[] { "Explosion" });
                UNLOAD_CHUNK = new PacketType(Play.PROTOCOL, Server.SENDER, 31, 29, new String[] { "UnloadChunk" });
                GAME_STATE_CHANGE = new PacketType(Play.PROTOCOL, Server.SENDER, 32, 30, new String[] { "GameStateChange" });
                KEEP_ALIVE = new PacketType(Play.PROTOCOL, Server.SENDER, 33, 31, new String[] { "KeepAlive" });
                MAP_CHUNK = new PacketType(Play.PROTOCOL, Server.SENDER, 34, 32, new String[] { "MapChunk" });
                WORLD_EVENT = new PacketType(Play.PROTOCOL, Server.SENDER, 35, 33, new String[] { "WorldEvent" });
                WORLD_PARTICLES = new PacketType(Play.PROTOCOL, Server.SENDER, 36, 34, new String[] { "WorldParticles" });
                LOGIN = new PacketType(Play.PROTOCOL, Server.SENDER, 37, 35, new String[] { "Login" });
                MAP = new PacketType(Play.PROTOCOL, Server.SENDER, 38, 36, new String[] { "Map" });
                ENTITY = new PacketType(Play.PROTOCOL, Server.SENDER, 39, 37, new String[] { "Entity" });
                REL_ENTITY_MOVE = new PacketType(Play.PROTOCOL, Server.SENDER, 40, 38, new String[] { "RelEntityMove" });
                REL_ENTITY_MOVE_LOOK = new PacketType(Play.PROTOCOL, Server.SENDER, 41, 39, new String[] { "RelEntityMoveLook" });
                ENTITY_LOOK = new PacketType(Play.PROTOCOL, Server.SENDER, 42, 40, new String[] { "EntityLook" });
                VEHICLE_MOVE = new PacketType(Play.PROTOCOL, Server.SENDER, 43, 41, new String[] { "VehicleMove" });
                OPEN_SIGN_EDITOR = new PacketType(Play.PROTOCOL, Server.SENDER, 44, 42, new String[] { "OpenSignEditor" });
                AUTO_RECIPE = new PacketType(Play.PROTOCOL, Server.SENDER, 45, 43, new String[] { "AutoRecipe" });
                ABILITIES = new PacketType(Play.PROTOCOL, Server.SENDER, 46, 44, new String[] { "Abilities" });
                COMBAT_EVENT = new PacketType(Play.PROTOCOL, Server.SENDER, 47, 45, new String[] { "CombatEvent" });
                PLAYER_INFO = new PacketType(Play.PROTOCOL, Server.SENDER, 48, 46, new String[] { "PlayerInfo" });
                LOOK_AT = new PacketType(Play.PROTOCOL, Server.SENDER, 49, -1, new String[] { "LookAt" });
                POSITION = new PacketType(Play.PROTOCOL, Server.SENDER, 50, 47, new String[] { "Position" });
                BED = new PacketType(Play.PROTOCOL, Server.SENDER, 51, 48, new String[] { "Bed" });
                RECIPES = new PacketType(Play.PROTOCOL, Server.SENDER, 52, 49, new String[] { "Recipes" });
                ENTITY_DESTROY = new PacketType(Play.PROTOCOL, Server.SENDER, 53, 50, new String[] { "EntityDestroy" });
                REMOVE_ENTITY_EFFECT = new PacketType(Play.PROTOCOL, Server.SENDER, 54, 51, new String[] { "RemoveEntityEffect" });
                RESOURCE_PACK_SEND = new PacketType(Play.PROTOCOL, Server.SENDER, 55, 52, new String[] { "ResourcePackSend" });
                RESPAWN = new PacketType(Play.PROTOCOL, Server.SENDER, 56, 53, new String[] { "Respawn" });
                ENTITY_HEAD_ROTATION = new PacketType(Play.PROTOCOL, Server.SENDER, 57, 54, new String[] { "EntityHeadRotation" });
                SELECT_ADVANCEMENT_TAB = new PacketType(Play.PROTOCOL, Server.SENDER, 58, 55, new String[] { "SelectAdvancementTab" });
                WORLD_BORDER = new PacketType(Play.PROTOCOL, Server.SENDER, 59, 56, new String[] { "WorldBorder" });
                CAMERA = new PacketType(Play.PROTOCOL, Server.SENDER, 60, 57, new String[] { "Camera" });
                HELD_ITEM_SLOT = new PacketType(Play.PROTOCOL, Server.SENDER, 61, 58, new String[] { "HeldItemSlot" });
                SCOREBOARD_DISPLAY_OBJECTIVE = new PacketType(Play.PROTOCOL, Server.SENDER, 62, 59, new String[] { "ScoreboardDisplayObjective" });
                ENTITY_METADATA = new PacketType(Play.PROTOCOL, Server.SENDER, 63, 60, new String[] { "EntityMetadata" });
                ATTACH_ENTITY = new PacketType(Play.PROTOCOL, Server.SENDER, 64, 61, new String[] { "AttachEntity" });
                ENTITY_VELOCITY = new PacketType(Play.PROTOCOL, Server.SENDER, 65, 62, new String[] { "EntityVelocity" });
                ENTITY_EQUIPMENT = new PacketType(Play.PROTOCOL, Server.SENDER, 66, 63, new String[] { "EntityEquipment" });
                EXPERIENCE = new PacketType(Play.PROTOCOL, Server.SENDER, 67, 64, new String[] { "Experience" });
                UPDATE_HEALTH = new PacketType(Play.PROTOCOL, Server.SENDER, 68, 65, new String[] { "UpdateHealth" });
                SCOREBOARD_OBJECTIVE = new PacketType(Play.PROTOCOL, Server.SENDER, 69, 66, new String[] { "ScoreboardObjective" });
                MOUNT = new PacketType(Play.PROTOCOL, Server.SENDER, 70, 67, new String[] { "Mount" });
                SCOREBOARD_TEAM = new PacketType(Play.PROTOCOL, Server.SENDER, 71, 68, new String[] { "ScoreboardTeam" });
                SCOREBOARD_SCORE = new PacketType(Play.PROTOCOL, Server.SENDER, 72, 69, new String[] { "ScoreboardScore" });
                SPAWN_POSITION = new PacketType(Play.PROTOCOL, Server.SENDER, 73, 70, new String[] { "SpawnPosition" });
                UPDATE_TIME = new PacketType(Play.PROTOCOL, Server.SENDER, 74, 71, new String[] { "UpdateTime" });
                TITLE = new PacketType(Play.PROTOCOL, Server.SENDER, 75, 72, new String[] { "Title" });
                STOP_SOUND = new PacketType(Play.PROTOCOL, Server.SENDER, 76, -1, new String[] { "StopSound" });
                NAMED_SOUND_EFFECT = new PacketType(Play.PROTOCOL, Server.SENDER, 77, 73, new String[] { "NamedSoundEffect" });
                PLAYER_LIST_HEADER_FOOTER = new PacketType(Play.PROTOCOL, Server.SENDER, 78, 74, new String[] { "PlayerListHeaderFooter" });
                COLLECT = new PacketType(Play.PROTOCOL, Server.SENDER, 79, 75, new String[] { "Collect" });
                ENTITY_TELEPORT = new PacketType(Play.PROTOCOL, Server.SENDER, 80, 76, new String[] { "EntityTeleport" });
                ADVANCEMENTS = new PacketType(Play.PROTOCOL, Server.SENDER, 81, 77, new String[] { "Advancements" });
                UPDATE_ATTRIBUTES = new PacketType(Play.PROTOCOL, Server.SENDER, 82, 78, new String[] { "UpdateAttributes" });
                ENTITY_EFFECT = new PacketType(Play.PROTOCOL, Server.SENDER, 83, 79, new String[] { "EntityEffect" });
                RECIPE_UPDATE = new PacketType(Play.PROTOCOL, Server.SENDER, 84, 84, new String[] { "RecipeUpdate" });
                TAGS = new PacketType(Play.PROTOCOL, Server.SENDER, 85, 85, new String[] { "Tags" });
        ...
        public static class Client extends PacketTypeEnum
        {
            ...
            public static final PacketType CLOSE_WINDOW;
            public static final PacketType CUSTOM_PAYLOAD;
            public static final PacketType BOOK_EDIT;
            ...
            public static final PacketType ADVANCEMENTS;
            public static final PacketType TRADE_SELECT;
            ...
            public static final PacketType STRUCTURE_BLOCK;
            public static final PacketType UPDATE_SIGN;
            ...
            static {
                ...
                TILE_NBT_QUERY = new PacketType(Play.PROTOCOL, Client.SENDER, 1, -1, new String[] { "TileNBTQuery" });
                CHAT = new PacketType(Play.PROTOCOL, Client.SENDER, 2, 2, new String[] { "Chat" });
                CLIENT_COMMAND = new PacketType(Play.PROTOCOL, Client.SENDER, 3, 3, new String[] { "ClientCommand" });
                SETTINGS = new PacketType(Play.PROTOCOL, Client.SENDER, 4, 4, new String[] { "Settings" });
                TAB_COMPLETE = new PacketType(Play.PROTOCOL, Client.SENDER, 5, 1, new String[] { "TabComplete" });
                TRANSACTION = new PacketType(Play.PROTOCOL, Client.SENDER, 6, 5, new String[] { "Transaction" });
                ENCHANT_ITEM = new PacketType(Play.PROTOCOL, Client.SENDER, 7, 6, new String[] { "EnchantItem" });
                WINDOW_CLICK = new PacketType(Play.PROTOCOL, Client.SENDER, 8, 7, new String[] { "WindowClick" });
                CLOSE_WINDOW = new PacketType(Play.PROTOCOL, Client.SENDER, 9, 8, new String[] { "CloseWindow" });
                CUSTOM_PAYLOAD = new PacketType(Play.PROTOCOL, Client.SENDER, 10, 9, new String[] { "CustomPayload" });
                BOOK_EDIT = new PacketType(Play.PROTOCOL, Client.SENDER, 11, -1, new String[] { "BEdit" });
                ENTITY_NBT_QUERY = new PacketType(Play.PROTOCOL, Client.SENDER, 12, -1, new String[] { "EntityNBTQuery" });
                USE_ENTITY = new PacketType(Play.PROTOCOL, Client.SENDER, 13, 10, new String[] { "UseEntity" });
                KEEP_ALIVE = new PacketType(Play.PROTOCOL, Client.SENDER, 14, 11, new String[] { "KeepAlive" });
                FLYING = new PacketType(Play.PROTOCOL, Client.SENDER, 15, 12, new String[] { "Flying" });
                POSITION = new PacketType(Play.PROTOCOL, Client.SENDER, 16, 13, new String[] { "Position" });
                POSITION_LOOK = new PacketType(Play.PROTOCOL, Client.SENDER, 17, 14, new String[] { "PositionLook" });
                LOOK = new PacketType(Play.PROTOCOL, Client.SENDER, 18, 15, new String[] { "Look" });
                VEHICLE_MOVE = new PacketType(Play.PROTOCOL, Client.SENDER, 19, 16, new String[] { "VehicleMove" });
                BOAT_MOVE = new PacketType(Play.PROTOCOL, Client.SENDER, 20, 17, new String[] { "BoatMove" });
                PICK_ITEM = new PacketType(Play.PROTOCOL, Client.SENDER, 21, -1, new String[] { "PickItem" });
                AUTO_RECIPE = new PacketType(Play.PROTOCOL, Client.SENDER, 22, 18, new String[] { "AutoRecipe" });
                ABILITIES = new PacketType(Play.PROTOCOL, Client.SENDER, 23, 19, new String[] { "Abilities" });
                BLOCK_DIG = new PacketType(Play.PROTOCOL, Client.SENDER, 24, 20, new String[] { "BlockDig" });
                ENTITY_ACTION = new PacketType(Play.PROTOCOL, Client.SENDER, 25, 21, new String[] { "EntityAction" });
                STEER_VEHICLE = new PacketType(Play.PROTOCOL, Client.SENDER, 26, 22, new String[] { "SteerVehicle" });
                RECIPE_DISPLAYED = new PacketType(Play.PROTOCOL, Client.SENDER, 27, 23, new String[] { "RecipeDisplayed" });
                ITEM_NAME = new PacketType(Play.PROTOCOL, Client.SENDER, 28, -1, new String[] { "ItemName" });
                RESOURCE_PACK_STATUS = new PacketType(Play.PROTOCOL, Client.SENDER, 29, 24, new String[] { "ResourcePackStatus" });
                ADVANCEMENTS = new PacketType(Play.PROTOCOL, Client.SENDER, 30, 25, new String[] { "Advancements" });
                TRADE_SELECT = new PacketType(Play.PROTOCOL, Client.SENDER, 31, -1, new String[] { "TrSel" });
                BEACON = new PacketType(Play.PROTOCOL, Client.SENDER, 32, -1, new String[] { "Beacon" });
                HELD_ITEM_SLOT = new PacketType(Play.PROTOCOL, Client.SENDER, 33, 26, new String[] { "HeldItemSlot" });
                SET_COMMAND_BLOCK = new PacketType(Play.PROTOCOL, Client.SENDER, 34, 34, new String[] { "SetCommandBlock" });
                SET_COMMAND_MINECART = new PacketType(Play.PROTOCOL, Client.SENDER, 35, 35, new String[] { "SetCommandMinecart" });
                SET_CREATIVE_SLOT = new PacketType(Play.PROTOCOL, Client.SENDER, 36, 27, new String[] { "SetCreativeSlot" });
                STRUCTURE_BLOCK = new PacketType(Play.PROTOCOL, Client.SENDER, 37, 37, new String[] { "Struct" });
                UPDATE_SIGN = new PacketType(Play.PROTOCOL, Client.SENDER, 38, 28, new String[] { "UpdateSign" });
                ARM_ANIMATION = new PacketType(Play.PROTOCOL, Client.SENDER, 39, 29, new String[] { "ArmAnimation" });
                SPECTATE = new PacketType(Play.PROTOCOL, Client.SENDER, 40, 30, new String[] { "Spectate" });
                USE_ITEM = new PacketType(Play.PROTOCOL, Client.SENDER, 41, 31, new String[] { "UseItem" });
                BLOCK_PLACE = new PacketType(Play.PROTOCOL, Client.SENDER, 42, 32, new String[] { "BlockPlace" });
                INSTANCE = new Client();
            }
        }
    }
    ...
    public static class Login
    {
        ...
        public static class Server extends PacketTypeEnum
        {
            ...
            static {
                ...
                CUSTOM_PAYLOAD = new PacketType(Login.PROTOCOL, Server.SENDER, 4, -1, new String[] { "CustomPayload" });
                INSTANCE = new Server();
            }
        }
        ...
        public static class Client extends PacketTypeEnum
        {
            ...
            static {
                ...
                CUSTOM_PAYLOAD = new PacketType(Login.PROTOCOL, Client.SENDER, 2, -1, new String[] { "CustomPayload" });
                INSTANCE = new Client();
            }
        }
    }
