...
class $Frame
{
    ...
    final void a(final $ClassWriter $ClassWriter, final int n, final Object[] array, final int n2, final Object[] array2) {
        for (int i = a($ClassWriter, n, array, this.c); i < array.length; this.c[i++] = 16777216) {}
        int n3 = 0;
        for (int j = 0; j < n2; ++j) {
        ...
        a($ClassWriter, n2, array2, this.d = new int[n2 + n3]);
        this.g = 0;
        this.h = 0;
    }
    
    private static int a(final $ClassWriter $ClassWriter, final int n, final Object[] array, final int[] array2) {
        int n2 = 0;
        for (int i = 0; i < n; ++i) {
            if (array[i] instanceof Integer) {
                ...
                array2[n2++] = b($ClassWriter, $Type.getObjectType((String)array[i]).getDescriptor());
            }
            else {
                array2[n2++] = (0x1800000 | $ClassWriter.a("", (($Label)array[i]).c));
            }
        }
        return n2;
    }
    
    final void b(final $Frame $Frame) {
        this.c = $Frame.c;
        this.d = $Frame.d;
        this.e = $Frame.e;
        this.f = $Frame.f;
    ...
    final void a(final $ClassWriter $ClassWriter, final int n, final $Type[] array, final int n2) {
        this.c = new int[n2];
        this.d = new int[0];
        int i = 0;
        if ((n & 0x8) == 0x0) {
    ...
    final boolean a(final $ClassWriter $ClassWriter, final $Frame $Frame, final int n) {
        boolean b = false;
